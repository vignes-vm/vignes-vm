# 💫 About Me:
🎓I'm an aspiring AI Engineer with a deep interest in solving real-world problems using Artificial Intelligence, Machine Learning, Deep learning and Data Science.<br><br>💡 I enjoy working on intelligent systems, optimizing solutions with code, and building models that matter.<br><br>With a strong grasp of Python, MATLAB, and C++, I'm comfortable working with both hardware and software tools for AI and embedded systems.
